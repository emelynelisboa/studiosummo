...
<body>
    <div id="gkWrap">
    	...
    	<div id="gkNav">
    		<div id="gkNavContent">
    			<a href="#" id="gk-btn-menu" ><?php echo JText::_('TPL_GK_CORPORATE2_GK_MOBILE_MENU'); ?></a>
    			<?php if($this->getParam('mobile_search', 0) == '1') : ?>
    			<a href="#" id="gk-btn-search" ><?php echo JText::_('TPL_GK_CORPORATE2_GK_MOBILE_SEARCH'); ?></a>
    			<?php endif; ?>
    			<a href="#" id="gk-btn-nav-prev" class="button"><span><?php echo JText::_('TPL_GK_CORPORATE2_GK_MOBILE_BACK'); ?></span></a>
    			<a href="#" id="gk-btn-nav-close" class="button"><span><?php echo JText::_('TPL_GK_CORPORATE2_GK_MOBILE_CLOSE'); ?></span></a>
    		</div>
	...
	<div id="gkTranslations">
		<span id="translation-name"><?php echo JText::_('TPL_GK_CORPORATE2_NAME'); ?></span>
		<span id="translation-confirm"><?php echo JText::_('TPL_GK_CORPORATE2_MOBILE_SWITCH_AGREE'); ?></span>
	</div>
