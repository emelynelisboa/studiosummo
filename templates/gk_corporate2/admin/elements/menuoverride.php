...
class JFormFieldMenuOverride extends JFormField
{
	...
	protected function getInput() {
		...
		$html .= '<div class="label">' . JText::_('TPL_GK_CORPORATE2_ADD_RULE_MENU_TYPE') . '</div>';
		$html .= JHtml::_('select.genericlist', $options, 'name', '', 'value', 'text', 'default', 'menu_override_select');
		$html .= '<input type="button" value="'.JText::_('TPL_GK_CORPORATE2_ADD_RULE').'" id="menu_override_add_btn" />';
