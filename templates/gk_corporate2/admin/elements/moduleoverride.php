...
class JFormFieldModuleOverride extends JFormField
{
	...
	protected function getInput() {
		$module_positions = split(',', $this->element['module_positions']);
		$module_styles = split(',', $this->element['module_styles']);
		$options_mp = array();
		$options_ms = array();
		...
		$html .= '<div class="label">' . JText::_('TPL_GK_CORPORATE2_ADD_RULE_MOD_POS') . '</div>';
		$html .= JHtml::_('select.genericlist', $options_mp, 'name', '', 'value', 'text', 'default', 'module_override_input');
		$html .= '<div class="label">' . JText::_('TPL_GK_CORPORATE2_ADD_RULE_STYLE') . '</div>';
		$html .= JHtml::_('select.genericlist', $options_ms, 'name', '', 'value', 'text', 'default', 'module_override_select');
		$html .= '<input type="button" value="'.JText::_('TPL_GK_CORPORATE2_ADD_RULE').'" id="module_override_add_btn" />';
