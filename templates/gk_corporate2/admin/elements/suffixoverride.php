...
class JFormFieldSuffixOverride extends JFormField
{
	...
	protected function getInput() {
		...
		$html .= '<div class="label">' . JText::_('TPL_GK_CORPORATE2_ADD_RULE_SUFFIX') . '</div>';
		$html .= '<input type="text" id="suffix_override_select" />';
		$html .= '<input type="button" value="'.JText::_('TPL_GK_CORPORATE2_ADD_RULE').'" id="suffix_override_add_btn" />';
