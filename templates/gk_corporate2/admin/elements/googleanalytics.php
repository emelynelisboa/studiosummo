...
class JFormFieldGoogleAnalytics extends JFormField
{
	...
	protected function getInput() {
		...
		$html .= '<div class="label">' . JText::_('TPL_GK_CORPORATE2_ADD_RULE_GA_CODE') . '</div>';
		$html .= '<input type="text" id="google_analytics_input" />';
		$html .= '<input type="button" value="'.JText::_('TPL_GK_CORPORATE2_ADD_RULE').'" id="google_analytics_add_btn" />';
