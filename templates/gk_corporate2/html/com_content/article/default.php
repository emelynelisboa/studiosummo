...
<?php endif; ?>
    ...
    <gavern:social><div id="gkSocialAPI"></gavern:social>
		...
		<fb:facepile href="<?php echo $cur_url; ?>" GK_FB_FACEPILE_SETTINGS></fb:facepile>
		...
		<a href="http://www.google.com/buzz/post" class="google-buzz-button" title="<?php echo JText::_('TPL_GK_PENGUINMAIL_GOOGLE_BUZZ_TITLE'); ?>" GK_BUZZ_BTN_SETTINGS data-url="<?php echo $cur_url; ?>"></a>
		<a href="http://www.delicious.com/save" onclick="window.open('http://www.delicious.com/save?v=5&noui&jump=close&url='+encodeURIComponent(location.href)+'&title='+encodeURIComponent(document.title), 'delicious','toolbar=no,width=550,height=550'); return false;" class="deliciousBtn" title="<?php echo JText::_('TPL_GK_PENGUINMAIL_DELICIOUS_TITLE'); ?>"></a>
		<a href="http://www.instapaper.com/hello2?url=<?php echo urlencode($cur_url); ?>&amp;title=<?php echo urlencode($this->item->title); ?>" class="instapaperBtn" title="<?php echo JText::_('TPL_GK_PENGUINMAIL_INSTAPAPER_TITLE'); ?>"></a>
