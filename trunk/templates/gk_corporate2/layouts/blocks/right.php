...
<div id="gkRight" class="gkMain gkCol <?php echo $this->generatePadding('gkRightColumn'); ?>">
	...
	<div id="gkRightMiddle" class="gkMain<?php echo $right_column_middle_class; ?> <?php echo $this->generatePadding('gkRightMiddle'); ?>">
		...
		<div id="gkRightRight" class="gkMain gkCol <?php echo $this->generatePadding('gkRightRight'); ?>">
