...
var GKNewsHighligher = new Class({
    ...
    initialize: function(options) {
        ...
        if(this.options.wrapper.getElement('.gkHighlighterWrapper .nowrap')) {
        	this.options.wrapper.getElement('.gkHighlighterWrapper .nowrap').setStyle('position', 'static');
        }
    ...
    slides: function() {
        ...
        //
		if ($this.options.mouseOver) { 
			$this.items.addEvent("mouseenter", function(){ $this.mouseIsOver = true; });
			$this.items.addEvent("mouseleave", function(){ $this.mouseIsOver = false; });
		}
		if($this.next) {
